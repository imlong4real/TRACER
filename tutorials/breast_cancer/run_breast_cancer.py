#!/usr/bin/env python3
"""
Run TRACER pipeline on breast cancer tissue data.

Reads:
 - data/breast_cancer_df_parquet  (Parquet file or directory)
...
def main():
    parser = argparse.ArgumentParser(description="Run TRACER pipeline on breast cancer tissue")
    ...
    parquet_path = data_dir / "breast_cancer_df.parquet"
    npmi_csv = data_dir / "breast_cancer_npmi.csv"

    print("Starting TRACER run on breast cancer tissue")
