#!/usr/bin/env python3
"""
Run TRACER pipeline on mouse ileum tissue data.
...
def main():
    parser = argparse.ArgumentParser(description="Run TRACER pipeline on mouse ileum tissue")
    ...
    print("Starting TRACER run on mouse ileum tissue")
